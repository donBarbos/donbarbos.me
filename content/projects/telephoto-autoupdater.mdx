---
title: telephoto-autoupdater
description: ️🦾 Application for auto update telegram profile photo.
date: "2022-11-14"
repository: donBarbos/telephoto-autoupdater
published: true
---
...
Distributed under the GPL-3.0 license. See [`LICENSE`](https://github.com/donBarbos/telephoto-autoupdater/blob/main/LICENSE) for more information.
