---
title: .mdShare
description: 📝 Best way to share your markdown files. (PaaS solution).
date: "2022-10-27"
repository: donBarbos/md-share
url: https://md-share.vercel.app
published: true
---

<h1 align="center">
  <a href="https://md-share.vercel.app">
    <img alt="Markdown" src="https://raw.githubusercontent.com/donBarbos/md-share/main/public/favicon.svg" width="140" /><br/>
  </a>
</h1>
...
See [`CONTRIBUTING.md`](https://github.com/donBarbos/md-share/blob/main/CONTRIBUTING.md)

## 📝 License

Distributed under the AGPL-3.0 license. See [`LICENSE`](https://github.com/donBarbos/md-share/blob/main/LICENSE) for more information.
